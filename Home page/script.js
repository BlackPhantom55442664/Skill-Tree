...
const data = [
    {
        place: 'Skill Tree Designer',
        title: 'CREATE',
        title2: 'YOUR PATH',
        description: 'Design custom skill trees with drag-and-drop nodes, curved connections, and personalized attributes. Build your learning journey with our intuitive visual editor.',
        image: "../Skill-tree/a2.jpg"
    },
    {
        place: 'Core Processor',
        title: 'MANAGE',
        title2: 'YOUR TREES',
        description: 'Access the central hub for managing all your skill trees. Monitor system status, organize projects, and access advanced features for power users.',
        image: "../Skill-tree/a1.jpg"
    },
    {
        place: 'Templates',
        title: 'EXPLORE',
        title2: 'PREBUILT',
        description: 'Discover pre-built skill tree templates for various domains. From programming languages to creative skills, find inspiration for your next project.',
        image: "../Skill-tree/Demo.jpg"
    }
];
